...
<html>
    ...
    <div class="outercard" style="align-self: center;"><!--outer translucent card contains header and footer-->
     <center>
     Type in your post down below!
     <br>
     <br>
     <form action="Forum_subthread.php" method="post" >
         
               <textarea style="color:white;font-family:Arial, Helvetica, sans-serif; background-color:rgba(12, 11, 11, 0.616) ; border:rgba(0, 0, 0, 0.644);border-bottom: 1px solid rgb(139, 5, 5);"name="message" rows="10" cols="60"> "Your post"</textarea>
               <br>
